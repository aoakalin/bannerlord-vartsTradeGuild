...
using vartsTradeGuild.leaderboard.vm;

namespace vartsTradeGuild.leaderboard
{
    [OverrideView(typeof (MenuTournamentLeaderboard))]
    public class GauntletMenuLeaderboardWorkshop : MenuView
    {
        private GauntletLayer _gauntletLayer;
        private LeaderboardWorkshopVM _dataSource;
        private GauntletMovie _movie;

        protected override void OnInitialize()
        {
            base.OnInitialize();
            this._dataSource = new LeaderboardWorkshopVM()
            {
                IsEnabled = true
            };
            GauntletLayer gauntletLayer = new GauntletLayer(205, "GauntletLayer");
            gauntletLayer.Name = "GauntletMenuLeaderboardWorkshop";
            this._gauntletLayer = gauntletLayer;
            this._gauntletLayer.InputRestrictions.SetInputRestrictions(true, InputUsageMask.All);
            this._gauntletLayer.Input.RegisterHotKeyCategory(HotKeyManager.GetCategory("GenericPanelGameKeyCategory"));
            this._movie = this._gauntletLayer.LoadMovie("GauntletMenuLeaderboardWorkshopMovie", (ViewModel) this._dataSource);
        ...
        protected override void OnFinalize()
        {
            ...
            this._dataSource = (LeaderboardWorkshopVM) null;
