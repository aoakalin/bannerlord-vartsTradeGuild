...
{
    public class LeaderboardWorkshopEntryItemVM : ViewModel
    {
        ...
        private VartsHeroVM _hero;

        public int Rank { get; private set; }

        public float PrizeValue { get; private set; }

        public LeaderboardWorkshopEntryItemVM(Hero hero, int prize, int placement)
        {
            this._heroObj = hero;
            ...
            this.Hero = new VartsHeroVM(hero);
            this.RefreshValues();
        }
