...
{
    public class LeaderboardWorkshopSortControllerVM : ViewModel
    {
        private readonly MBBindingList<LeaderboardWorkshopEntryItemVM> _listToControl;
        ...
        public LeaderboardWorkshopSortControllerVM(
            ref MBBindingList<LeaderboardWorkshopEntryItemVM> listToControl)
        {
        ...
        private void ExecuteSortByName()
        {
            ...
            this._listToControl.Sort((IComparer<LeaderboardWorkshopEntryItemVM>) this._nameComparer);
        ...
        private void ExecuteSortByPrize()
        {
            ...
            this._listToControl.Sort((IComparer<LeaderboardWorkshopEntryItemVM>) this._prizeComparer);
        ...
        private void ExecuteSortByPlacement()
        {
            ...
            this._listToControl.Sort((IComparer<LeaderboardWorkshopEntryItemVM>) this._placementComparer);
        ...
        private void ExecuteSortByVictories()
        {
            ...
            this._listToControl.Sort((IComparer<LeaderboardWorkshopEntryItemVM>) this._victoriesComparer);
        ...
        private abstract class ItemComparerBase : IComparer<LeaderboardWorkshopEntryItemVM>
        {
            ...
            public abstract int Compare(
                LeaderboardWorkshopEntryItemVM x,
                LeaderboardWorkshopEntryItemVM y);
        }
