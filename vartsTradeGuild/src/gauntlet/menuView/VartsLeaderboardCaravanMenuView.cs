...
namespace vartsTradeGuild.gauntlet.menuView
{
    ...
    public class VartsLeaderboardCaravanMenuView : MenuView
    {
        private GauntletLayer _gauntletLayer;
        private VartsLeaderboardCaravanVM _dataSource;
        private GauntletMovie _movie;

        protected override void OnInitialize()
        {
            base.OnInitialize();
            this._dataSource = new VartsLeaderboardCaravanVM()
            {
                IsEnabled = true
            };
            GauntletLayer gauntletLayer = new GauntletLayer(205, "GauntletLayer");
            gauntletLayer.Name = "VartsLeaderboardCaravanMenuView";
            this._gauntletLayer = gauntletLayer;
            this._gauntletLayer.InputRestrictions.SetInputRestrictions(true, InputUsageMask.All);
            this._gauntletLayer.Input.RegisterHotKeyCategory(HotKeyManager.GetCategory("GenericPanelGameKeyCategory"));
            this._movie =
                this._gauntletLayer.LoadMovie("VartsLeaderboardCaravanMenuViewMovie", (ViewModel) this._dataSource);
        ...
        protected override void OnFinalize()
        {
            ...
            this._dataSource = (VartsLeaderboardCaravanVM) null;
