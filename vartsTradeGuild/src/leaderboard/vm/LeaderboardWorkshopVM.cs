...
//{
//    public class LeaderboardWorkshopVM : ViewModel
//    {
...
//        private MBBindingList<LeaderboardWorkshopEntryItemVM> _entries;
//        private LeaderboardWorkshopSortControllerVM _sortController;
//
//        public LeaderboardWorkshopVM()
//        {
//            this.Entries = new MBBindingList<LeaderboardWorkshopEntryItemVM>();
...
//            {
//                MBBindingList<LeaderboardWorkshopEntryItemVM> entries = this.Entries;
...
//                LeaderboardWorkshopEntryItemVM leaderboardEntryItemVm =
//                    new LeaderboardWorkshopEntryItemVM(key, prize, placement);
//                entries.Add(leaderboardEntryItemVm);
//            }
//
//            this.SortController = new LeaderboardWorkshopSortControllerVM(ref this._entries);
//            this.RefreshValues();
//        }
//
...
//            this.Entries.ApplyActionOnAllItems((Action<LeaderboardWorkshopEntryItemVM>) (x => x.RefreshValues()));
...
//
//        [DataSourceProperty]
//        public LeaderboardWorkshopSortControllerVM SortController
//        {
...
//
//        [DataSourceProperty]
//        public MBBindingList<LeaderboardWorkshopEntryItemVM> Entries
//        {
